...
$query="SELECT *, CONCAT(nama_depan,' ',nama_belakang) AS nama_user FROM detail_pesanan dp
            ...
            WHERE p.id_toko='$idToko' AND dp.id_sp=4 ";
...
if (isset($_GET['kategori'])) {
    ...
    if (isset($_GET['urutan'])) {
        $urutan = $_GET['urutan'];
        if ($urutan=='Terbaru') {
            $query .= "AND kategori='$kategori' ORDER BY tgl_selesai DESC";
        }elseif ($urutan=='Terlama') {
            $query .= "AND kategori='$kategori' ORDER BY tgl_selesai ASC";
        }
    }else {
    ...
    if (isset($_GET['urutan'])) {
        ...
        if ($urutan=='Terbaru') {
            ...
            $query .= "ORDER BY tgl_selesai ASC";
        }
    }
}
...
<body data-spy="scroll" data-target="#navbarResponsive" class="bg-light">
    ...
    <div class="main">
        ...
        <ul class="nav nav-tabs mt-3">
            <li class="nav-item">
                <a class="nav-link ml-4" href="pesanan-baru.php">Pesanan Baru</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="pesanan-terkirim.php">Pesanan Terkirim</a>
            </li>
            <li class="nav-item ml-4">
                <a class="nav-link  active font-weight-bold" href="pesanan-selesai.php">Pesanan Selesai</a>
            </li>
        </ul>
        <!-- end menu pesanan -->
